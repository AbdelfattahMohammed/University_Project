    ...
    <div class="main-content">
        ...
        <div class="holder">
            ...
            <script>
                ...
                function loadAttendance(year, selectedDate = null) {
                    const tableBody = document.getElementById("attendanceTable");
                    // Show loading message
                    tableBody.innerHTML = `<tr><td colspan="3" class="text-center">Loading attendance records...</td></tr>`;

                    // Use the new dynamic route with the year parameter
                    let url = `/attendance-by-year/${year}`;

                    // Add date parameter if selectedDate is provided
                    if (selectedDate) {
                    ...
                    fetch(url)
                        .then(response => {
                            if (!response.ok) {
                                // Throw an error for HTTP errors (e.g., 404, 500)
                        ...
                        .then(data => {
                            ...
                            if (data.length > 0) {
                                data.forEach(record => {
                                    // If attendance.status is NULL (due to leftJoin), treat as Absent
                                ...
                                tableBody.innerHTML = `<tr><td colspan="3" class="text-center">No attendance records found for this year and date.</td></tr>`;
                            }
                ...
                function updateChart(present, absent) {
                    ...
                    attendanceChart = new Chart(ctx, {
                        ...
                        options: {
                            responsive: true,
                            maintainAspectRatio: false, // Allow chart to adjust freely
                            scales: {
                                y: {
                                    beginAtZero: true,
                                    ticks: {
                ...
                document.getElementById("selectYear").addEventListener("change", function () {
                    ...
                    loadAttendance(currentYear, selectedDate);
                });
