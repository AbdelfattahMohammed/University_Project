...
<body>
    ...
    <div class="main-content">
        ...
        <div class="holder">
            ...
            <div class="container">
    <h2 class="text-center mb-4">Level 4 - Semester 2 Courses</h2>
    ...
    <div class="row">
                                            ...
                                            <ul class="list-unstyled mb-0"> {{-- استخدم list-unstyled لإزالة النقاط الافتراضية --}}
                                                @foreach($course->instructors as $instructor)
                                                    <li class="text-muted small">
                                                        <i class="fa-solid fa-user-tie me-1"></i> {{ $instructor->full_name }} ({{ $instructor->position }})
                                                    </li>
                                                @endforeach
                                            </ul>
                                        @else
        ...
        @empty
            <div class="col-12">
                <p class="alert alert-info text-center">No departments have courses available for this level and semester.</p>
            </div>
        @endforelse
    </div>
</div>
